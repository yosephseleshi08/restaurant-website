    ...
    DEFAULT_DATA = {
        ...
        'menu': {
            ...
            'small plates': [
                ...
                {'name': 'Crispy Calamari', 'description': 'Lightly fried squid, lemon aioli, marinara, fresh herbs', 'price': 19.00, 'popular': True, 'image': 'https://images.unsplash.com/photo-1599487488170-d11ec45f5650?w=600&h=400&fit=crop', 'dietary': []},
                {'name': 'Mezze Platter', 'description': 'Hummus, baba ganoush, tzatziki, warm pita, marinated olives', 'price': 24.00, 'popular': False, 'image': 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?w=600&h=400&fit=crop', 'dietary': ['vegetarian']}
            ],
            'mains': [
                ...
                {'name': 'Lobster Linguine', 'description': 'Fresh Maine lobster, cherry tomatoes, white wine, garlic, basil', 'price': 52.00, 'popular': True, 'image': 'https://images.unsplash.com/photo-1563379926898-05f4575a45d7?w=600&h=400&fit=crop', 'dietary': []},
                {'name': 'Grilled Swordfish', 'description': 'Caper berry relish, roasted fennel, citrus vinaigrette', 'price': 44.00, 'popular': False, 'image': 'https://images.unsplash.com/photo-1580476262798-bddd9f4b7369?w=600&h=400&fit=crop', 'dietary': ['gluten-free', 'dairy-free']}
            ],
            'desserts': [
                ...
                {'name': 'Tiramisu', 'description': 'Classic Italian tiramisu, espresso-soaked ladyfingers, cocoa', 'price': 14.00, 'popular': True, 'image': 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=600&h=400&fit=crop', 'dietary': ['vegetarian']},
                {'name': 'Panna Cotta', 'description': 'Vanilla bean panna cotta, seasonal berry compote, mint', 'price': 12.00, 'popular': False, 'image': 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=600&h=400&fit=crop', 'dietary': ['vegetarian', 'gluten-free']}
            ],
            'drinks': [
                ...
                {'name': 'Mediterranean Mule', 'description': 'Vodka, fig syrup, fresh lime, ginger beer, rosemary', 'price': 16.00, 'popular': True, 'image': 'https://images.unsplash.com/photo-1536935338788-846bb9981813?w=600&h=400&fit=crop', 'dietary': ['vegan']},
                {'name': 'Espresso Martini', 'description': 'Vodka, fresh espresso, coffee liqueur, vanilla', 'price': 17.00, 'popular': True, 'image': 'https://images.unsplash.com/photo-1544145945-f90425340c7e?w=600&h=400&fit=crop', 'dietary': ['vegan']}
            ],
            'wine selection': [
                ...
                {'name': 'Provence Rosé', 'description': 'Miraval, 2023 — Fresh strawberry, white peach, mineral', 'price': 18.00, 'popular': True, 'image': 'https://images.unsplash.com/photo-1558001373-7b93ee48ffa0?w=600&h=400&fit=crop', 'dietary': ['vegan', 'gluten-free']}
            ]
        },
        ...
        'gallery': {'enabled': True, 'page_title': 'Gallery', 'page_subtitle': 'A glimpse into our kitchen, our craft, and the warm, sun-drenched atmosphere.', 'photos': [
            ...
            {'url': 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800&h=600&fit=crop', 'caption': 'Chef Elena plating the signature dish', 'category': 'food'},
            {'url': 'https://images.unsplash.com/photo-1544025162-d76694265947?w=800&h=600&fit=crop', 'caption': 'Grilled Spanish octopus', 'category': 'food'},
            {'url': 'https://images.unsplash.com/photo-1563379926898-05f4575a45d7?w=800&h=600&fit=crop', 'caption': 'Fresh lobster linguine', 'category': 'food'},
            {'url': 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=800&h=600&fit=crop', 'caption': 'Truffle paccheri pasta', 'category': 'food'},
            {'url': 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=800&h=600&fit=crop', 'caption': 'Our signature olive oil cake', 'category': 'food'},
            {'url': 'https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?w=800&h=600&fit=crop', 'caption': 'The Aegean cocktail', 'category': 'drinks'},
            {'url': 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=800&h=600&fit=crop', 'caption': 'Santorini Sunset aperitif', 'category': 'drinks'},
            {'url': 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=800&h=600&fit=crop', 'caption': 'Santorini Assyrtiko wine', 'category': 'drinks'},
            {'url': 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=800&h=600&fit=crop', 'caption': 'Negroni Bianco', 'category': 'drinks'},
            {'url': 'https://images.unsplash.com/photo-1544145945-f90425340c7e?w=800&h=600&fit=crop', 'caption': 'Espresso Martini', 'category': 'drinks'},
            {'url': 'https://images.unsplash.com/photo-1558001373-7b93ee48ffa0?w=800&h=600&fit=crop', 'caption': 'Provence Rosé selection', 'category': 'drinks'},
            {'url': 'https://images.unsplash.com/photo-1536935338788-846bb9981813?w=800&h=600&fit=crop', 'caption': 'Mediterranean Mule', 'category': 'drinks'},
            {'url': 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=800&h=600&fit=crop', 'caption': 'The bar at Aurelia', 'category': 'interior'},
            {'url': 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800&h=600&fit=crop', 'caption': 'Candlelit dinner setting', 'category': 'interior'}
        ]},
...
# ✅ FIX 3: Fixed the fatal indentation/syntax bug at the bottom
