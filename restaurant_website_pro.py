...
def create_app(config_name="production"):
    ...
    # ... [KEEP YOUR ENTIRE ORIGINAL DEFAULT_DATA DICTIONARY EXACTLY AS IT WAS] ...
    DEFAULT_DATA = {
    ...
    # FIX 3: Dashboard route now passes 'reservations' to prevent 500 error
    @app.route('/dashboard')
    def dashboard():
        ...
        return render_template('dashboard.html', theme=data['theme'], restaurant=data['restaurant'], analytics=data['analytics'], settings=data['settings'], reservations=reservations)
    ...
    # FIX 4: Added Cart API endpoints so orders.html works
...
# FIX 5: Fixed the fatal indentation/syntax bug at the bottom
